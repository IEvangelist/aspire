...
<div style="color: var(--aspire-color-white); background: var(--aspire-color-primary); padding: 2rem 4rem; border-radius: 1rem; margin-bottom: 2rem; margin-left: -4rem; margin-right: -4rem;">
  <h5 style="color: var(--aspire-color-white)">Free and Open Source</h5>
