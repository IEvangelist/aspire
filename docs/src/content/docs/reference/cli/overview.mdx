...
<LinkButton href="../install" variant="primary">Install the Aspire CLI</LinkButton>
...
[_Command reference: `aspire run`_](../commands/aspire-run)
...
[_Command reference: `aspire add`_](../commands/aspire-add)
...
[_Command reference: `aspire publish`_](../commands/aspire-publish)
...
[_Command reference: `aspire deploy`_](../commands/aspire-deploy)
...
[_Command reference: `aspire config`_](../commands/aspire-config)
...
[_Command reference: `aspire exec`_](../commands/aspire-exec)
