...
[_Command reference: `aspire run`_](/aspire/reference/cli/commands/aspire-run)
...
[_Command reference: `aspire add`_](/aspire/reference/cli/commands/aspire-add)
...
[_Command reference: `aspire publish`_](/aspire/reference/cli/commands/aspire-publish)
...
[_Command reference: `aspire deploy`_](/aspire/reference/cli/commands/aspire-deploy)
...
[_Command reference: `aspire config`_](/aspire/reference/cli/commands/aspire-config)
...
[_Command reference: `aspire exec`_](/aspire/reference/cli/commands/aspire-exec)
