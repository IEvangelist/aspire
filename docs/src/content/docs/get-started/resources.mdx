...
<LearnMore>
  Learn more about [Resource Hierarchies](/aspire/architecture/resource-hierarchies) and how to represent them.
</LearnMore>
...
<LearnMore>
  Learn more about [Built-In Resources & Lifecycle](/aspire/architecture/resource-model-overview/#built-in-resources--lifecycle).
</LearnMore>
