...
<LearnMore>
  Explore how [Built-In Resources and Lifecycle](/aspire/architecture/resource-model/#built-in-resources-and-lifecycle) work together to power your applications.
</LearnMore>
