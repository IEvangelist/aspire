...
To access these types and APIs for expressing them as resources in your [AppHost](/aspire/get-started/welcome) project, install the [📦 Aspire.Hosting.PostgreSQL](https://www.nuget.org/packages/Aspire.Hosting.PostgreSQL) NuGet package:
